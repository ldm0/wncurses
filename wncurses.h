...
//for different bits version programs
#if 0 && defined(_LP64)
...
int mvscanw (int,int, NCURSES_CONST char *,...)	/* implemented */
...
int mvwscanw (WINDOW *,int,int, NCURSES_CONST char *,...)	/* implemented */
int mvwvline (WINDOW *,int, int, chtype, int);	/* generated */
int napms (int);					/* implemented */
WINDOW* newpad (int,int);		       	/* implemented */
SCREEN* newterm (NCURSES_CONST char *,FILE *,FILE *);	/* implemented */
...
int scanw (NCURSES_CONST char *,...)		/* implemented */
...
int vwscanw (WINDOW *, NCURSES_CONST char *,va_list);	/* implemented */
int vw_scanw (WINDOW *, NCURSES_CONST char *,va_list);	/* generated */
...
int wscanw (WINDOW *, NCURSES_CONST char *,...)	/* implemented */
 ...
 */
int tigetflag (NCURSES_CONST char *);		/* implemented */
int tigetnum (NCURSES_CONST char *);		/* implemented */
char* tigetstr (NCURSES_CONST char *);		/* implemented */
int putp (const char *);				/* implemented */

#if NCURSES_TPARM_VARARGS
char* tparm (NCURSES_CONST char *, ...);	/* special */
#else
char* tparm (NCURSES_CONST char *, NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG,NCURSES_TPARM_ARG);	/* special */
char* tparm_varargs (NCURSES_CONST char *, ...);	/* special */
#endif
